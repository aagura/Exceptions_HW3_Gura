...
//    ошибки. Создать метод, который обработает его и покажет пользователю сообщение, что он ввел меньше или больше
...
//    должен увидеть стектрейс ошибки
        ...
        public static void main(String[] args) {
            ...
            try {
                String[] userData = Datachek.DataCheck(input);
                WriteFile.writeFile(userData);
